...
void APowerUpHeal::BeginPlay()
{
	...
	RingMesh->OnComponentBeginOverlap.AddDynamic(this, &APowerUpHeal::OnOverlap);
...
void APowerUpHeal::OnOverlap(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
